    ...
    <div className="min-h-screen bg-cream font-ui">
      <main className="container mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <div className="h-8 w-48 bg-cream-dark rounded mx-auto mb-3 animate-pulse" />
          <div className="h-4 w-80 bg-cream-dark rounded mx-auto animate-pulse" />
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {Array.from({ length: 6 }).map((_, idx) => (
            <div key={idx} className="border border-cream-deeper rounded-lg overflow-hidden">
              <div className="aspect-video bg-cream-dark animate-pulse" />
